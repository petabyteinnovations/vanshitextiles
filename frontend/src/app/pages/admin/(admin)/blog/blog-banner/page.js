...
export default function Page() {
    ...
    const handleImageChange = (e) => {
        ...
        updateField("Blog_Banner_Image", file);
        setPreview(file);
    };

    const removeImage = () => {
        setPreview(null);
        updateField("Blog_Banner_Image", "");
    };
    ...
    const insertdata = (e) => {
        ...
        apiurl
            .post("/admin/add-blogs-banner", toFormData(inputfield), {
                headers: {
            ...
            <section className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div>
                    ...
                    <p className="mt-1 text-gray-500">
                        Manage blog banner section from one place.
                    </p>

                </div>

                <Link
                    href="/pages/admin/blog/blog-banner/view-blog-banner"
                ...
                <section className="my-2 w-[50%] rounded-[10px] bg-white p-3 shadow">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <label
                                htmlFor="Blog_Banner_Description"
                                className="mb-2 block text-sm font-medium text-gray-700"
                            >
