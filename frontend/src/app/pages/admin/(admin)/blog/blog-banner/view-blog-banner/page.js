                ...
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="rounded-2xl border border-gray-200 bg-white px-6 py-16 text-center">
                        ...
                        <h2 className="mt-5 text-lg font-semibold text-[#0A2342]">
                            No Blog Banner Found
                        </h2>

                        <p className="mx-auto mt-2 max-w-md text-sm text-gray-500">
                            No blog banner has been configured yet.
                        </p>
                ...
                <section className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-10">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-gray-500">
                            View and manage your blog banner section.
                        </p>
          ...
          ======================================================== */}
                    ...
                    <div className="relative h-72 w-full overflow-hidden sm:h-96 lg:h-105">
                        ...
                        {banner.Blog_Banner_Image ? (
                            <Image
                                src={`${imageUrl}/${banner.Blog_Banner_Image}`}
                                alt={
          ...
          ======================================================== */}
              ...
              ======================================================== */}
                            ...
                            <div className="flex items-start">
                                ...
                                <Link
                                    href={`/pages/admin/blog/blog-banner/update-blog-banner?_id=${banner._id}`}
