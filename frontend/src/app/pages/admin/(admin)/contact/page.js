...
export default function Page() {
    ...
    const handleImageChange = (e) => {
        ...
        updateField("Contact_Banner_Image", file);
        setPreview(file);
    };

    const removeImage = () => {
        setPreview(null);
        updateField("Contact_Banner_Image", "");
    };
    ...
    const insertdata = (e) => {
        ...
        apiurl
            .post("/admin/add-contact-banner", toFormData(inputfield), {
                headers: {
            ...
            <section className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div>
                    ...
                    <p className="mt-1 text-gray-500">
                        Manage contact banner section from one place.
                    </p>

                </div>

                <Link
                    href="/pages/admin/contact/view-contact-banner"
                ...
                <section className="my-2 w-[50%] rounded-[10px] bg-white p-3 shadow">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <label
                                htmlFor="Contact_Banner_Heading"
                        ...
                        <div>
                            ...
                            <label
                                htmlFor="Contact_Banner_Description"
                                className="mb-2 block text-sm font-medium text-gray-700"
                            >
                            ...
                            <div className="p-6">
                                ...
                                <p className="mt-4 leading-7 text-gray-500 whitespace-pre-line">
                                    {inputfield.Contact_Banner_Description ||
                                        "Your Contact description will appear here. Add a meaningful description to preview the Contact content."}
                                </p>
                            </div>
