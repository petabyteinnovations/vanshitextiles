...
export default function page() {
    ...
    let [inputfield, setinputfield] = useState({
        ...
        Banner_Tag: urlvalues.get('Banner_Tag'),
        Banner_Main_Heading: urlvalues.get('Banner_Main_Heading'),
        Banner_Description: urlvalues.get('Banner_Description'),
        Banner_Primary_Btn_Text: urlvalues.get('Banner_Primary_Btn_Text'),
        Banner_Primary_Btn_Link: urlvalues.get('Banner_Primary_Btn_Link'),
        Banner_Secondary_Btn_Text: urlvalues.get('Banner_Secondary_Btn_Text'),
        Banner_Secondary_Btn_Link: urlvalues.get('Banner_Secondary_Btn_Link'),
        Banner_Image: '',
        Banner_Status: urlvalues.get('Banner_Status'),
    })
    ...
    let insertdata = (e) => {
        try {
            e.preventDefault();
            apiurl.put("/admin/update-home-banner", toFormData(inputfield), {
                headers: {
                        ...
                        <form className="space-y-5" onSubmit={insertdata}>
                            ...
                            <section>
                                ...
                                <input
                                    id="banner_tag"
                                    type="text"
                                    defaultValue={urlvalues.get('Banner_Tag')}
                            ...
                            <section>
                                ...
                                <input
                                    id="main_heading"
                                    type="text"
                                    defaultValue={urlvalues.get('Banner_Main_Heading')}
                            ...
                            <section>
                                ...
                                <textarea
                                    ...
                                    defaultValue={urlvalues.get('Banner_Description')}
                                    rows={4}
                            ...
                            <section className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        defaultValue={urlvalues.get('Banner_Primary_Btn_Text')}
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        defaultValue={urlvalues.get('Banner_Primary_Btn_Link')}
                            ...
                            <section className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        defaultValue={urlvalues.get('Banner_Secondary_Btn_Text')}
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        defaultValue={urlvalues.get('Banner_Secondary_Btn_Link')}
                                    ...
                                    !inputfield.Banner_Image?
                                        <div className="relative overflow-hidden rounded-2xl border-2 border-dashed border-gray-300 bg-gray-50 transition-all duration-300 hover:border-[#D4AF37] hover:bg-[#FFF9EC]">
                                            <input
                                                ...
                                                defaultValue={inputfield.Banner_Image}
                                        ...
                                        <div className="mt-3 flex items-center gap-4 overflow-hidden rounded-2xl border border-gray-200 bg-white p-3">
                                            <div className="relative h-16 w-24 shrink-0 overflow-hidden rounded-lg bg-gray-100">
                                                <Image
                                                    src={preview === null ? urlvalues.get('Banner_Image') : URL.createObjectURL(preview)}
                                                    alt="Banner preview"
                                                    width={100}
                                                    height={100}
                            ...
                            <section className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select id="banner_status"
                                        ...
                                        defaultValue={urlvalues.get('Banner_Status')}
                                    >
                        ...
                        <div>
                            <div className="overflow-hidden rounded-2xl bg-white shadow-xl">
                                ...
                                <section
                                    ...
                                    style={{
                                        backgroundImage:
                                            `url(${preview === null ? urlvalues.get('Banner_Image') : URL.createObjectURL(preview)
                                            })`,
                                    }}
                                >
