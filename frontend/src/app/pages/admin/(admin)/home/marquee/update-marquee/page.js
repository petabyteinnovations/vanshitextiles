...
export default function Page() {
    ...
    const [inputfield, setinputfield] = useState({
        _id: urldata.get('_id'),
        Marquee_Text: urldata.get('Marquee_Text'),
        Marquee_Status: urldata.get('Marquee_Status'),
    });
    ...
    const insertdata = async (e) => {
        try {
            ...
            apiurl
                .put("/admin/update-home-marquee", inputfield, {
                    headers: {
                        ...
                        >
                            ...
                            <section>
                                ...
                                <textarea
                                    ...
                                    defaultValue={inputfield.Marquee_Text}
                                    onChange={(e) =>
                                        setinputfield({
                                            ...inputfield,
                            ...
                            <section>
                                ...
                                <select
                                    ...
                                    defaultValue={inputfield.Marquee_Status}
                                    onChange={(e) =>
                                        setinputfield({
                                            ...inputfield,
