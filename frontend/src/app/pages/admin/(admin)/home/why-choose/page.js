...
import { Home, ArrowUpRight, PanelRightDashed } from "lucide-react";

const HOME_SECTIONS = [
    {
        title: "Why Choose Banner",
        description:
            "Manage why choose banner, heading, button and banner image.",
        icon: Home,
    ...
    {
        title: "Why Choose Card",
        description:
            "Manage why choose card, heading, Icon image.",
            ...
            <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    <div className="flex items-center gap-2 text-sm text-gray-500">
                        ...
                        <span>CMS</span>
                        <span>/</span>
                        <span className="font-medium text-[#0A2342]">Why Choose CMS</span>
                    </div>
                    ...
                    <p className="mt-1 text-gray-500">
                        Manage all why choose sections from one place.
                    </p>
                </div>
