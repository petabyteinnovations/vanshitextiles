...
export default function Page() {
    ...
    let insertdata = (e) => {
        try {
            e.preventDefault();
            apiurl.post("/admin/add-why-choose-banner", toFormData(inputfield), {
                headers: {
            ...
            <section className="w-full">
                <section className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div className="flex flex-wrap gap-3">
                        <Link href={"/pages/admin/home/why-choose/why-choose-banner/view-why-choose-banner"} className="bg-[#0A2342] p-3 px-4 rounded-xl text-white font-medium">
                            View Banner
                        </Link>
                    </div>
                </section>
                ...
                <section className="w-full mt-6 flex items-start justify-between gap-4">
                    ...
                    <section className="w-[50%] my-2 overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-lg">
                        ...
                        <div className="overflow-hidden rounded-b-2xl">
                            ...
                            <section
                                className="relative h-175 w-full bg-cover bg-center py-5"
                                style={{
                                    backgroundImage: `url(${preview === null
                                        ? "https://images.unsplash.com/photo-1523381210434-271e8be1f52b?w=1800"
                            ...
                            >
                                ...
                                <div className="relative z-10 flex h-full max-w-3xl flex-col justify-end px-10 lg:px-10 text-white">

                                    <p className="text-sm font-semibold uppercase tracking-[8px] text-[#D4AF37]">

                                        {inputfield.Banner_Tag || "Manufacturing Excellence"}

                                    </p>

                                    <h1 className="mt-6 text-2xl font-light leading-tight lg:text-5xl">
                                    ...
                                    <div className="mt-10 flex flex-wrap gap-5">
                                        ...
                                        <span className="rounded-full bg-[#D4AF37] px-8 py-4 text-base font-semibold text-[#0A2342] shadow-lg">
                                        ...
                                        <span className="rounded-full border border-white px-8 py-4 text-base font-semibold text-white backdrop-blur-sm">
