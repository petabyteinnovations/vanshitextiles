...
import { Wallpaper, ArrowUpRight, ChevronsLeftRightEllipsis, MailQuestionMark } from "lucide-react";

const HOME_SECTIONS = [
  {
    title: "Home Hero Banner",
    description:
      "Manage homepage banner, heading, button and background image.",
    icon: Wallpaper,
  ...
  },
  {
    title: "Home Marquee",
    description:
      "Manage homepage marquee content.",
  ...
  },
  {
    ...
    href: "/pages/admin/home/why-choose",
    color: "bg-pink-50 text-pink-600",

  },
  {
    title: "Home Manufacturing Process",
    description:
      "Manage manufacturing process content.",
    icon: MailQuestionMark,
      ...
      <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <div className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <span>CMS</span>
            <span>/</span>
            <span className="font-medium text-[#0A2342]">Home Page</span>
          </div>
          ...
          <p className="mt-1 text-gray-500">
            Manage all homepage sections from one place.
          </p>
        </div>
