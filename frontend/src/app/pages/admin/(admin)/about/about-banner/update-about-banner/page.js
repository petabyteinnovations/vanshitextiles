...
export default function Page() {
            ...
            apiurl
                ...
                .then((res) => {
                    if (res.data.Status === 1) {
                        ...
                        if (banner?.About_Banner_Image) {
                            setPreview(
                                `${imageurl.replace(/\/$/, "")}/${banner.About_Banner_Image.replace(/^\//, "")}`
                            );
                        } else {
                            setPreview(null);
                        }
    ...
    const updatedata = async (e) => {
        try {
            ...
            if (inputfield.About_Banner_Image instanceof File) {
                formData.append(
                    "About_Banner_Image",
                    inputfield.About_Banner_Image
                );
            }
                ...
                <section className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-gray-500">
                            Manage the about page banner from one place.
                        </p>
