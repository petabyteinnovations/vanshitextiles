...
export default function Page() {
    ...
    const handleImageChange = (e) => {
        ...
        updateField("About_Banner_Image", file);
        setPreview(file);
    };

    const removeImage = () => {
        setPreview(null);
        updateField("About_Banner_Image", "");
    };
    ...
    const insertdata = (e) => {
        ...
        apiurl
            .post("/admin/add-about-banner", toFormData(inputfield), {
                headers: {
            ...
            <section className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div>
                    ...
                    <p className="mt-1 text-gray-500">
                        Manage about banner section from one place.
                    </p>

                </div>

                <Link
                    href="/pages/admin/about/about-banner/view-about-banner"
                ...
                <section className="my-2 w-[50%] rounded-[10px] bg-white p-3 shadow">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <label
                                htmlFor="About_Banner_Description"
                                className="mb-2 block text-sm font-medium text-gray-700"
                            >
                    ...
                    <div className="flex items-center justify-between border-b border-gray-200 px-6 py-5">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-sm text-gray-500">
                                This is how the about banner will appear on the website.
                            </p>
                        ...
                        <div className="overflow-hidden border border-gray-100 bg-white shadow-sm">
                            ...
                            <div className="p-6">
                                ...
                                <h3 className="text-2xl font-bold leading-tight text-[#0A2342]">
                                    {inputfield.About_Banner_Heading ||
                                        "Your About Title"}
                                </h3>

                                <p className="mt-4 leading-7 text-gray-500 whitespace-pre-line">
                                    {inputfield.About_Banner_Description ||
