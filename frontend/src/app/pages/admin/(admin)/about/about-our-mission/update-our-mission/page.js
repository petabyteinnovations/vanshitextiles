...
export default function Page() {
    ...
    const getdata = async () => {
        try {
            apiurl
                .get("/admin/view-about-our-mission", {
                    headers: {
                ...
                .then((res) => {
                    if (res.data.Status === 1) {
                        ...
                        setInputfield({
                            _id: banner?._id || "",
                            About_Our_Mission_Heading:
                                banner?.About_Our_Mission_Heading || "",
                            About_Our_Mission_Description:
                                banner?.About_Our_Mission_Description || ""
                        });
                    } else {
    ...
    const updatedata = async (e) => {
        try {
            ...
            apiurl
                .put(
                    "/admin/update-about-our-mission",
                    inputfield,
                    {
                        headers: {
                            Authorization: localStorage.getItem("token"),
                ...
                <section className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-gray-500">
                            Manage the about page our mission from one place.
                        </p>
                    ...
                    <section className="my-2 w-full rounded-[10px] bg-white p-3 shadow lg:w-[50%]">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <label
                                    htmlFor="About_Our_Mission_Heading"
                            ...
                            <div>
                                ...
                                <label
                                    htmlFor="About_Our_Mission_Description"
                                    className="mb-2 block text-sm font-medium text-gray-700"
                                >
                                ...
                                <textarea
                                    id="About_Our_Mission_Description"
                                    rows={6}
