            ...
            <div className="mx-auto max-w-7xl">
                ...
                <section className="mb-10 flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div>
                        ...
                        <h1 className="mt-2 text-3xl font-bold text-[#0A2342]">
                            View About Our Mission
                        </h1>

                        <p className="mt-1 text-gray-500">
                            View and manage about our mission section from one place.
                        </p>
                    ...
                    <div className="p-6 sm:p-8">
                        ...
                        <div className="grid gap-8 lg:grid-cols-[1fr_auto]">
                            ...
                            <div className="flex items-start">
                                ...
                                <Link
                                    href={`/pages/admin/about/about-our-mission/update-our-mission?_id=${banner._id}`}
