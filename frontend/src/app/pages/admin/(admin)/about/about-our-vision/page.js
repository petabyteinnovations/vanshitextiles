...
export default function Page() {
    ...
    const insertdata = (e) => {
        ...
        apiurl
            .post("/admin/add-about-our-vision", inputfield, {
                headers: {
            ...
            <section className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div>
                    ...
                    <p className="mt-1 text-gray-500">
                        Manage about our vision section from one place.
                    </p>

                </div>

                <Link
                    href="/pages/admin/about/about-our-vision/view-our-vision"
                    ...
                    >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => setInputfield({ ...inputfield, "About_Our_Vision_Heading": e.target.value })}
                            />
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={6}
                                placeholder="Enter our vision description..."
                                className="w-full resize-none rounded-xl border border-gray-300 p-3 outline-none focus:border-[#D4AF37]"
                                onChange={(e) => setInputfield({ ...inputfield, "About_Our_Vision_Description": e.target.value })}
                            />
                            ...
                            <div className="p-6">
                                ...
                                <p className="mt-4 leading-7 text-gray-500 whitespace-pre-line">
                                    {inputfield?.About_Our_Vision_Description ||
                                        "Your our vision title description will appear here. Add a meaningful description to preview the content."}
                                </p>
                            </div>
