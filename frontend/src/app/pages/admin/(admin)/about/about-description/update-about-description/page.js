...
export default function Page() {
    ...
    const getdata = async () => {
        try {
            apiurl
                .get("/admin/view-about-description", {
                    headers: {
                ...
                .then((res) => {
                    if (res.data.Status === 1) {
                        ...
                        setInputfield({
                            _id: banner?._id || "",
                            About_Description_Heading:
                                banner?.About_Description_Heading || "",
                            About_Description:
                                banner?.About_Description|| "",
                            About_Description_Image:
                                banner?.About_Description_Image || ""
                        });

                        if (banner?.About_Description_Image) {
                            setPreview(
                                `${imageurl.replace(/\/$/, "")}/${banner.About_Description_Image.replace(/^\//, "")}`
                            );
                        } else {
                            setPreview(null);
                        }
    ...
    const updatedata = async (e) => {
        try {
            ...
            if (inputfield.About_Description_Image instanceof File) {
                formData.append(
                    "About_Description_Image",
                    inputfield.About_Description_Image
                );
            }

            apiurl
                .put(
                    "/admin/update-about-description",
                    formData,
                    {
                        headers: {
                            Authorization: localStorage.getItem("token"),
                ...
                <section className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-gray-500">
                            Manage the about page description from one place.
                        </p>
